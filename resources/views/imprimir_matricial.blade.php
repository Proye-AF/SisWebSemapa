<!-- resources/views/reporte_combustible/imprimir_matricial.blade.php -->
<link rel="stylesheet" type="text/css" href="{{ asset('sema/impr.css') }}">

@extends('layouts.app')
<div class="primera-parte">
    <div style=" justify-content: space-between; font-weight: bold; margin-top: 10px; margin-bottom:10px">
        <div class="logo-container">
            <h6 style="font-weight: bold;" class="titulo">PEDIDO COMBUSTIBLE</h6>
        </div>
    ...
    <div class="datos-vehiculo">
        <h6 style="font-weight: bold;">Datos del Vehículo</h6>
        <table>
            <tr>
                <th>No Móvil:</th>
    ...
    <div class="datos-combustible">
        <h6 style="font-weight: bold;">Datos del Combustible</h6>
        <table>
            <tr>
                <th>Combustible:</th>
